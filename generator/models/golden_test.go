...
func TestModelFileGeneration__GoldenFile(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "Should generate model for User with one-to-many relation to Posts",
			fileName:      "user_with_posts_relation_model",
			migrationsDir: "user_posts_relation",
			tableName:     "users",
			resourceName:  "User",
			modulePath:    "github.com/example/relations",
			databaseType:  "postgresql",
		},
		{
			name:          "Should generate model for Post with many-to-one relation to User",
			fileName:      "post_with_user_relation_model",
			migrationsDir: "user_posts_relation",
			tableName:     "posts",
			resourceName:  "Post",
			modulePath:    "github.com/example/relations",
		...
		{
			name:          "Should generate model for User with many-to-many relation to Roles",
			fileName:      "user_with_roles_relation_model",
			migrationsDir: "user_roles_relation",
			tableName:     "users",
			resourceName:  "User",
			modulePath:    "github.com/example/relations",
			databaseType:  "postgresql",
		...
		{
			name:          "Should generate model for Role with many-to-many relation to Users",
			fileName:      "role_with_users_relation_model",
			migrationsDir: "user_roles_relation",
			tableName:     "roles",
			resourceName:  "Role",
			modulePath:    "github.com/example/relations",
		...
		{
			name:          "Should generate model for Category with self-referential relations",
			fileName:      "category_with_hierarchy_relation_model",
			migrationsDir: "category_hierarchy",
...
func TestQueriesFileGeneration__GoldenFile(t *testing.T) {
	tests := []struct {
		...
		{
			name:          "Should generate SQL for User with one-to-many relation to Posts",
			fileName:      "user_with_posts_relation_queries",
			migrationsDir: "user_posts_relation",
			tableName:     "users",
			resourceName:  "User",
			databaseType:  "postgresql",
		...
		{
			name:          "Should generate SQL for Post with many-to-one relation to User",
			fileName:      "post_with_user_relation_queries",
			migrationsDir: "user_posts_relation",
			tableName:     "posts",
			resourceName:  "Post",
			databaseType:  "postgresql",
		...
		{
			name:          "Should generate SQL for User with many-to-many relation to Roles",
			fileName:      "user_with_roles_relation_queries",
			migrationsDir: "user_roles_relation",
			tableName:     "users",
			resourceName:  "User",
			databaseType:  "postgresql",
		...
		{
			name:          "Should generate SQL for Role with many-to-many relation to Users",
			fileName:      "role_with_users_relation_queries",
			migrationsDir: "user_roles_relation",
			tableName:     "roles",
			resourceName:  "Role",
			databaseType:  "postgresql",
		...
		{
			name:          "Should generate SQL for Category with self-referential relations",
			fileName:      "category_with_hierarchy_relation_queries",
			migrationsDir: "category_hierarchy",
			tableName:     "categories",
			resourceName:  "Category",
			databaseType:  "postgresql",
