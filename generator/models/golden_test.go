...
func TestConstructorFileGeneration__GoldenFile(t *testing.T) {
	tests := []struct {
		name          string
		fileName      string
		migrationsDir string
		...
		{
			name:          "Should generate constructors for simple users table",
			fileName:      "simple_user_table_constructors",
			migrationsDir: "simple_user_table",
			tableName:     "users",
			resourceName:  "User",
			modulePath:    "github.com/example/myapp",
		...
		{
			name:          "Should generate constructors for complex table",
			fileName:      "complex_table_constructors",
			migrationsDir: "complex_table",
			tableName:     "comprehensive_example",
			resourceName:  "ComprehensiveExample",
			modulePath:    "github.com/example/complex",
		...
		{
			name:          "Should generate SQLite constructors for users table",
			fileName:      "sqlite_user_table_constructors",
			migrationsDir: "sqlite_user_table",
			tableName:     "users",
			resourceName:  "User",
			modulePath:    "github.com/example/sqlite",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g.Assert(t, tt.fileName, constructorContent)
		})
	}
}
