...
func CreateComprehensiveExample(
	...
	params := newInsertComprehensiveExampleParams(
		data.UuidId,
		data.SmallInt,
...
func UpdateComprehensiveExample(
	...
	params := newUpdateComprehensiveExampleParams(
		data.ID,
		func() uuid.UUID {
...
func PaginateComprehensiveExamples(
	...
	rows, err := db.New().QueryPaginatedComprehensiveExamples(
		ctx,
		dbtx,
		newQueryPaginatedComprehensiveExamplesParams(pageSize, offset),
	)
	if err != nil {
		return PaginatedComprehensiveExamples{}, err
	}
...
) db.InsertComprehensiveExampleParams {
	return db.InsertComprehensiveExampleParams{
		ID:                uuid.New(),
		UuidId:            uuidid,
		SmallInt:          smallint,
...
func newUpdateComprehensiveExampleParams(
	...
	bigintrange pgtype.Int8range,
	numericrange pgtype.Numrange,
) db.UpdateComprehensiveExampleParams {
	return db.UpdateComprehensiveExampleParams{
		ID:                id,
		UuidId:            uuidid,
		SmallInt:          smallint,
		RegularInt:        regularint,
...
func newQueryPaginatedComprehensiveExamplesParams(limit, offset int64) db.QueryPaginatedComprehensiveExamplesParams {
	return db.QueryPaginatedComprehensiveExamplesParams{
		Limit:  limit,
		Offset: offset,
	}
}
