...
func inertiaPayloadTypeName(view *GeneratedView) string {
	return view.ResourceName + "Data"
}

func inertiaCreateFormPayloadType(view *GeneratedView) string {
	return "Create" + view.ResourceName + "FormPayload"
}

func inertiaUpdateFormPayloadType(view *GeneratedView) string {
	return "Update" + view.ResourceName + "FormPayload"
}
...
func inertiaPayloadImportPath(_ *GeneratedView) string {
...
func (g *Generator) GenerateInertiaViewFiles(
	...
	customFuncs := template.FuncMap{
		...
		"InertiaCreateFormPayload": func() string {
			return inertiaCreateFormPayloadType(view)
		},
		"InertiaUpdateFormPayload": func() string {
			return inertiaUpdateFormPayloadType(view)
		},
