...
var baseTailwindTemplateMappings = map[TmplTarget]TmplTargetPath{
	...
	// Examples
	"tw_examples_html_display.tmpl":     "examples/html/display.html",
	"tw_examples_html_data.tmpl":        "examples/html/data.html",
	"tw_examples_html_forms.tmpl":       "examples/html/forms.html",
	"tw_examples_html_feedback.tmpl":    "examples/html/feedback.html",
	"tw_examples_html_interactive.tmpl": "examples/html/interactive.html",
	"tw_examples_html_navigation.tmpl":  "examples/html/navigation.html",
	"tw_examples_html_overlays.tmpl":    "examples/html/overlays.html",
}
