...
var baseTailwindTemplateMappings = map[TmplTarget]TmplTargetPath{
	...
	"tw_views_components_shared.tmpl":        "views/components/shared.templ",
	"tw_views_components_form_controls.tmpl": "views/components/form_controls.templ",
	"tw_views_components_actions.tmpl":       "views/components/actions.templ",
	"tw_views_components_data_display.tmpl":  "views/components/data_display.templ",
	"tw_views_components_feedback.tmpl":      "views/components/feedback.templ",
	"tw_views_components_navigation.tmpl":    "views/components/navigation.templ",
	"tw_views_components_overlay.tmpl":       "views/components/overlay.templ",
