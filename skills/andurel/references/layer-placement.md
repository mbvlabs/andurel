...
| Middleware and request/session plumbing | `router/middleware/` and `router/cookies/` (named cookie definitions; values travel through `pkg/kiks` on `context.Context`) |
